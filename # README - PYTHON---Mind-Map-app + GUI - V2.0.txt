...
ChatGPT said:
ChatGPT
Here’s a GUI version for your app, enhanced for usability with better layout and additional functionality for a smoother user experience.

I'll make the GUI more polished by introducing labels, a better-organized layout using Frame, and a menu bar for additional functionality.

Mind Map Gui

Answer in chat instead
This version improves usability by adding:

Frames: Separates different UI sections for better organization.
Menu Bar: Allows users to access file operations from the menu.
File Dialogs: Saves and loads files with user-defined paths.
Clear Button: Lets users reset the mind map.
Let me know if you'd like additional customizations! 🖥️✨
